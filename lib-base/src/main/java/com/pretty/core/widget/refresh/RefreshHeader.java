package com.pretty.core.widget.refresh;
...
class RefreshHeader extends FrameLayout implements IRefreshStatus {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.l_ptr_refresh_header, this);
        ptrArrow = view.findViewById(R.id.ptr_arrow);
        ptrPb = view.findViewById(R.id.ptr_progressbar);
        ptrTv = view.findViewById(R.id.ptr_tv);
    }
